...
pub fn embeddings_store(
    ...
    conn.execute(
        "INSERT OR REPLACE INTO embeddings (chunk_id, file_path, chunk_text, start_line, end_line, embedding) VALUES (?1, ?2, ?3, ?4, ?5, ?6)",
        params![chunk_id, file_path, chunk_text, start_line, end_line, blob],
